...
# ─────────────────────────────────────────────────────────────────────────────
NIFTY250_SYMBOLS = [
    "HDFCBANK.NS", "ICICIBANK.NS", "RELIANCE.NS", "BHARTIARTL.NS", "BSE.NS",
    "LT.NS", "SBIN.NS", "INFY.NS", "AXISBANK.NS", "BAJFINANCE.NS",
    ...
    "ASTRAL.NS", "AUROPHARMA.NS", "AIIL.NS", "DMART.NS", "BAJAJ-AUTO.NS",
    "BAJAJFINSV.NS", "BAJAJHLDNG.NS", "BAJAJHFL.NS", "BALKRISIND.NS", "BANKBARODA.NS",
    "BANKINDIA.NS", "MAHABANK.NS", "BERGEPAINT.NS", "BDL.NS", "BEL.NS",
    "BHARATFORG.NS", "BHEL.NS", "BPCL.NS", "BHARTIHEXA.NS", "GROWW.NS",
    "BIOCON.NS", "BLUESTARCO.NS", "BOSCHLTD.NS", "BRITANNIA.NS", "CGPOWER.NS",
    "CRISIL.NS", "CANBK.NS", "CHOLAFIN.NS", "CIPLA.NS", "COALINDIA.NS",
    "COCHINSHIP.NS", "COFORGE.NS", "COLPAL.NS", "CONCOR.NS", "COROMANDEL.NS",
    "CUMMINSIND.NS", "DLF.NS", "DABUR.NS", "DALBHARAT.NS", "DIVISLAB.NS",
    "DIXON.NS", "DRREDDY.NS", "EICHERMOT.NS", "ENDURANCE.NS", "ESCORTS.NS",
    "ETERNAL.NS", "EXIDEIND.NS", "NYKAA.NS", "FEDERALBNK.NS", "FORTIS.NS",
    "GAIL.NS", "GVT&D.NS", "GMRAIRPORT.NS", "GICRE.NS", "GLAXO.NS",
    "GLENMARK.NS", "MEDANTA.NS", "GODFRYPHLP.NS", "GODREJCP.NS", "GODREJIND.NS",
    "GODREJPROP.NS", "GRASIM.NS", "FLUOROCHEM.NS", "HCLTECH.NS", "HDBFS.NS",
    "HDFCAMC.NS", "HDFCLIFE.NS", "HAVELLS.NS", "HEROMOTOCO.NS", "HEXT.NS",
    "HINDALCO.NS", "HAL.NS", "HINDPETRO.NS", "HINDUNILVR.NS", "HINDZINC.NS",
    "POWERINDIA.NS", "HONAUT.NS", "HUDCO.NS", "HYUNDAI.NS", "ICICIGI.NS",
    "ICICIAMC.NS", "ICICIPRULI.NS", "IDFCFIRSTB.NS", "ITCHOTELS.NS", "ITC.NS",
    "INDIANB.NS", "INDHOTEL.NS", "IOC.NS", "IRCTC.NS", "IRFC.NS",
    "IREDA.NS", "INDUSTOWER.NS", "INDUSINDBK.NS", "NAUKRI.NS", "INDIGO.NS",
    "IPCALAB.NS", "JKCEMENT.NS", "JSWENERGY.NS", "JSWINFRA.NS", "JSWSTEEL.NS",
    "JSL.NS", "JINDALSTEL.NS", "JIOFIN.NS", "JUBLFOOD.NS", "KPRMILL.NS",
    "KEI.NS", "KPITTECH.NS", "KALYANKJIL.NS", "KOTAKBANK.NS", "LTF.NS",
    "LTTS.NS", "LGEINDIA.NS", "LICHSGFIN.NS", "LTM.NS", "LAURUSLABS.NS",
    ...
    "NLCINDIA.NS", "NMDC.NS", "NTPCGREEN.NS", "NTPC.NS", "NATIONALUM.NS",
    "NESTLEIND.NS", "NAM-INDIA.NS", "OBEROIRLTY.NS", "ONGC.NS", "OIL.NS",
    "PAYTM.NS", "OFSS.NS", "POLICYBZR.NS", "PIIND.NS", "PAGEIND.NS",
    "PATANJALI.NS", "PERSISTENT.NS", "PETRONET.NS", "PHOENIXLTD.NS", "PIDILITIND.NS",
    "POLYCAB.NS", "PFC.NS", "POWERGRID.NS", "PREMIERENE.NS", "PRESTIGE.NS",
    "PNB.NS", "RECLTD.NS", "RADICO.NS", "RVNL.NS", "SBICARD.NS",
    "SBILIFE.NS", "SJVN.NS", "SRF.NS", "MOTHERSON.NS", "SCHAEFFLER.NS",
